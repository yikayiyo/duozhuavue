		...
		<div class="user-header-wrapper text-white wrapper-bg">
			...
			<div class="user-head">
				...
				>
					...
					<router-link to="/notifications" class="flex flex-col items-center p-3">
				...
				<div v-else class="splitter flex items-center justify-between px-5%">
					<span class="left flex-1 border-t-0.5 border-splitter dark:border-darkborder"></span>
					<div class="circle mx-1.25"></div>
					<span class="right flex-1 border-t-0.5 border-splitter dark:border-darkborder"></span>
				</div>
