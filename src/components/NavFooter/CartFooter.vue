<template>
	<div
		class="cart-footer-wrapper flex items-center fixed max-w-dzy mx-auto my-0 bottom-0 inset-x-0 border-t border-b dark:border-darkborder z-50 bg-white dark:bg-black h-16"
	>
		<div class="home">
			<router-link to="/book" class="inline-block mx-6.25 pt-1.25">
				<svg
		...
		<div class="pipe w-0.25 h-11 bg-menu dark:bg-darkborder"></div>
		<div class="cart">
			<router-link to="/cart" class="inline-block mx-6.25 pt-1.25">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 200 200"
					style="width: 30px; height: 30px"
		...
		<div class="button-wrapper flex-1 mr-3.75 overflow-hidden">
			<button
				class="w-full text-white bg-add-to-cart rounded-full h-11 cursor-not-allowed"
				disabled
			>加入购物车</button>
		</div>
	</div>
