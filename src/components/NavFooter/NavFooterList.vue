	...
	<ul class="flex flex-row justify-between items-center">
		...
		<li class="flex-1 flex flex-col items-center">
			<router-link
				class="flex flex-col items-center"
				to="/cart"
				:active-class="$route.path === '/cart' ? 'is-active' : ''"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 200 200"
		...
		<li class="flex-1 flex flex-col items-center">
			<router-link
				class="flex flex-col items-center"
				to="/users/0"
				:active-class="$route.path === '/users/0' ? 'is-active' : ''"
			>
				<svg viewBox="0 0 200 200" style="height: 30px; width: 30px">
					<path
					...
					<circle
						...
						cy="68.03"
						r="4.85"
						transform="rotate(-13.17 84.01 68.028)"
					></circle>
					<path
						d="M113.24 63.22a4.85 4.85 0 104.12 5.48 4.85 4.85 0 00-4.12-5.48z"
					></path>
				</svg>
