<template>
	<a class="douban-wrapper" :href="'https://book.douban.com/isbn/' + isbn">
		<div class="flex items-center px-3 h-13 bg-douban dark:bg-darkbg rounded">
			...
			<div class="stars flex ml-auto">
				<div
					class="star relative mr-0.75"
					v-for="(score, idx) of ratingArray"
					:key="idx"
				>
					<div
						class="star-back absolute h-3 overflow-hidden"
						:style="{
							width: (score / 2) * 13 + 'px',
						}"
					>
...
export default {
	...
	computed: {
		ratingArray() {
			...
			res.push(Number(rating));
			if (res.length !== 5) res.push(0);
			return res;
		},
	},
};
